                    ...
                    <div className="h-72 w-full mt-auto">
                        <ResponsiveContainer width="100%" height="100%">
                            <LineChart data={volumeView === 'Week' ? weeklyData : monthlyData}>
                                ...
                                <XAxis dataKey="day" axisLine={{ stroke: '#F1F5F9', strokeWidth: 1 }} tickLine={false} tick={{fill: '#94A3B8', fontWeight: 600, fontSize: 13}} dy={10} />
                                <YAxis axisLine={{ stroke: '#F1F5F9', strokeWidth: 1 }} tickLine={false} tick={{fill: '#94A3B8', fontWeight: 600, fontSize: 13}} />
                                <Tooltip 
                        ...
                        <ResponsiveContainer width="100%" height="100%">
                            <PieChart>
                                <Pie
                                    ...
                                    paddingAngle={10}
                                    dataKey="value"
                                    onClick={(data, index) => setShowRiskModal(riskData[index])}
                            ...
                            <div className="h-40 w-full mb-6 relative">
                                <ResponsiveContainer width="100%" height="100%">
                                    <LineChart data={historyRecords}>
                                        <XAxis dataKey="date" axisLine={{ stroke: '#F1F5F9', strokeWidth: 1 }} tickLine={false} tick={{fill: '#94A3B8', fontWeight: 600, fontSize: 10}} dy={10} />
